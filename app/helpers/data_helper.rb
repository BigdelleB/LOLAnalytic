module DataHelper
	...
	#returns massive JSON of ranked stats
	def ranked_stats_JSON(login)
		summoner_id(login)
		#url="https://"+@@region+".api.pvp.net/api/lol/"+@@region+"/v1.3/by-summoner/" + @@champ_id.to_s+"/ranked?season=SEASON2015&api_key=28ba1d65-cda8-4e79-90ad-aad6b1ab6326"
